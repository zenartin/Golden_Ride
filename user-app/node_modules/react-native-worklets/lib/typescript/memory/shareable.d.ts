 ...
 */
export declare function createShareable<TValue = unknown, THostDecorated = unknown, TGuestDecorated = unknown>(_hostRuntimeId: number, _initial: TValue, _config?: ShareableConfig<TValue, THostDecorated, TGuestDecorated>): Shareable<TValue, THostDecorated, TGuestDecorated>;
