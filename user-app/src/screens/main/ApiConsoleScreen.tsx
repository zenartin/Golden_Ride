...
const styles = StyleSheet.create({
  ...
  subtitle: { color: Colors.textSecondary, fontSize: Typography.body, marginTop: 2 },
  card: {
    backgroundColor: Colors.surface,
    borderRadius: 20,
    padding: Spacing.lg,
  ...
  sectionTitle: { color: Colors.textPrimary, fontSize: Typography.subHeading, fontWeight: "900" },
  ...
  path: { color: Colors.textPrimary, fontSize: Typography.small, fontWeight: "800" },
  rideRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
  ...
  rideTitle: { color: Colors.textPrimary, fontSize: Typography.body, fontWeight: "800" },
  status: { color: Colors.primary, fontSize: Typography.small, fontWeight: "900" },
  tokenText: { color: Colors.textSecondary, fontSize: Typography.small, lineHeight: 18, fontWeight: "700" },
  responseText: { color: Colors.white, fontSize: Typography.small, lineHeight: 18 },
});
